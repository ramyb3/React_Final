...
function Menu()
{
    ...
    return(<div>
        ...
        <div style={{textAlign: "center"}}>
            <Link to="products"><input type="button" value="Products" className='button' style={{height: '30px', fontSize: '15px'}}/></Link>&nbsp;
            <Link to="customers"><input type="button" value="Customers" className='button' style={{height: '30px', fontSize: '15px'}}/></Link>
        </div>
