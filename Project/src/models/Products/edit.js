...
function EditProduct()
{
    ...
    return(<div>
        ...
        <div style={{float: "left", width: "50%"}}>
            ...
            <Link to="/products"><input type="button" onClick={send} value="Update" style={{cursor: "pointer"}}/></Link>
            <Link to="/products"><input type="button" onClick={() => dispatch({type : "deleteProduct", payload : product.ID })} value="Delete" style={{cursor: "pointer"}}/></Link>
