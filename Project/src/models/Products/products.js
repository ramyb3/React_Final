...
function Products()
{
    ...
    return(<div>
        ...
        <div style={{float: "left", width: "45%"}}>
            ...
            <Link to="addProduct"><input type="button" value="Add Product" style={{cursor: "pointer"}}/></Link><br/><br/>
          
            {
                storeData[0][1].map((item,index)=>
                {
                    return <div key={index}><table style={{width: "85%"}} border="1" >
                                    ...
                                    return <div key={i}>
                                        ...
                                        {x.Products.find(z=> z.ProductID==item.ID)!= undefined ? 
                                            ...
                                            <>  
                                                ...
                                                <input type="button" value="Add" onClick={()=> (setAdd(true),setId(x.CustomerID))} style={{cursor: "pointer"}}/><br/>
        ...
        <div style={{float: "right", width: "25%", textAlign: "left"}}>
