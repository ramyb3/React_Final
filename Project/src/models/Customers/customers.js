...
function Customers()
{
    ...
    return(<div>
        ...
        <div className='customers'>
            ...
            <Link to="addCustomer"><input type="button" value="Add Customer" className='button'/></Link><br/><br/>
               ...
               
                {
                    storeData[0][0].map((item,index)=>
                    {
                        return <tbody key={index}><tr>
                            ...
                            <td>
                            {purchases.find(z=> z.CustomerID==item.ID) != undefined ?
                            ...
                            <td><input type="button" onClick={()=> (setAdd(true),setId(item.ID))} value="Buy Products" className='button'/></td>
        ...
        {add==true ?
            ...
            <div className='buy'>
                ...
                <h3> Customer: <u>{storeData[0][0].find(z=> z.ID==id).Fname} {storeData[0][0].find(z=> z.ID==id).Lname}</u></h3>
                ...
                <input type="button" value="Buy" onClick={addProducts} className='button'/><br/><br/>
